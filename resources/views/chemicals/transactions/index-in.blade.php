...
@section('page_title', 'chemical In')

@section('bread_crumb')
    <ol class="breadcrumb float-sm-right">
        <a href="{{ route('chemical-in.create') }}" class="btn float-right bg-success"><i class="fa fa-plus"></i> New
            Chemical In Transaction
        </a>
    </ol>
@endsection
                            ...
                            @foreach ($transactions as $transaction)
                                ...
                                <div class="modal fade" id="modal-lg-{{ $transaction->id }}">
                                    <div class="modal-dialog modal-lg">
                                            <form method="post" action="{{ route('chemical-in.reverse') }}">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="transaction_id"
                                                                ...
                                                                value="{{ $transaction->chemical->id }}" required hidden>                                                           

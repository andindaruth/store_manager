...
@section('page_title', 'fertiliser Out')

@section('bread_crumb')
    <ol class="breadcrumb float-sm-right">
        <a href="{{ route('fertiliser-out.create') }}" class="btn float-right bg-success"><i
            class="fa fa-plus"></i> New
            fertiliser Out Transaction
    </a>
    </ol>
@endsection
                            ...
                            @foreach ($transactions as $transaction)
                                ...
                                <div class="modal fade" id="modal-lg-{{ $transaction->id }}">
                                    <div class="modal-dialog modal-lg">
                                            <form method="post" action="{{ route('fertiliser-out.reverse') }}">

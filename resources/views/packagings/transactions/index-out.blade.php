...
@section('page_title', 'packaging Out')

@section('bread_crumb')
    <ol class="breadcrumb float-sm-right">
        <a href="{{ route('packaging-out.create') }}" class="btn float-right bg-success"><i
            class="fa fa-plus"></i> New
        packaging Out Transaction
    </a>
    </ol>
@endsection
                            ...
                            @foreach ($transactions as $transaction)
                                ...
                                <div class="modal fade" id="modal-lg-{{ $transaction->id }}">
                                    <div class="modal-dialog modal-lg">
                                            <form method="post" action="{{ route('packaging-out.reverse') }}">

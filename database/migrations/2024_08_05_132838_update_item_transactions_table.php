...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('item_transactions', function (Blueprint $table) {
            ...
            $table->foreign('reversed_by')->references('id')->on('item_transactions')->onDelete('set null');
            $table->unsignedBigInteger('reverses')->nullable();
            $table->foreign('reverses')->references('id')->on('item_transactions')->onDelete('set null');
        });

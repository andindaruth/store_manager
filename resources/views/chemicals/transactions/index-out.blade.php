...
@section('page_title', 'chemical Out')

@section('bread_crumb')
    <ol class="breadcrumb float-sm-right">
        <a href="{{ route('chemical-out.create') }}" class="btn float-right bg-success"><i
            class="fa fa-plus"></i> New
        chemical Out Transaction
    </a>
    </ol>
@endsection
                            ...
                            @foreach ($transactions as $transaction)
                                ...
                                <div class="modal fade" id="modal-lg-{{ $transaction->id }}">
                                    <div class="modal-dialog modal-lg">
                                            <form method="post" action="{{ route('chemical-out.reverse') }}">
